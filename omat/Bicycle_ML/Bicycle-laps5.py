...
print('RANSACregression score for training dataset is:', RAregTr.score(X_train, y_train))
print('BayesianRidge score for test training is:', BAregTr.score(X_train, y_train))
print('LassoLARS score for test training is:', LARSregTr.score(X_train, y_train))
print("##########################################################")
...
print('RANSACregression score for validation dataset is:', RAregTr.score(X_val, y_val))
print('BayesianRidge score for validation dataset is:', BAregTr.score(X_val, y_val))
print('LassoLARS score for validation dataset is:', LARSregTr.score(X_val, y_val))
print("##########################################################")
...
print('RANSACregression score for test dataset is:', RAregTr.score(X_test, y_test))
print('BayesianRidge score for test dataset is:', BAregTr.score(X_test, y_test))
print('LassoLARS score for test dataset is:', LARSregTr.score(X_test, y_test))
